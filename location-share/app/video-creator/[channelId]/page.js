...
import { CHANNEL_DEFINITIONS, GENRES, getTopicsByGenre, getTopicsByChannelId, getDefaultGenreForChannel } from '@/lib/financeTopics';
...
export default function ChannelVideoCreator() {
  ...
  const handleGenreChange = (g) => {
    ...
    if (topics.length) setSelectedTopic(topics[0]);
  };
  ...
  }, [selectedTopic, genre, format, language]);
        ...
        <div className={styles.autoPanel}>
          ...
          <div className={styles.autoSection}>
            ...
            <div className={styles.topicRow}>
              ...
              <button className={styles.autoBtn} onClick={handleGenerateTitles} disabled={generating || !selectedTopic}>
                {generating
