...
import WorkPatternAnalysis from './WorkPatternAnalysis';
        ...
        <div className="sidebar-brand">
          <button
            ...
            style={{
              ...
              color: 'var(--text-muted)', padding: '5px 10px', borderRadius: '6px',
              cursor: 'pointer', fontSize: '12px', marginRight: '8px', flexShrink: 0,
            }}
          >
            ←
          </button>
        ...
        {!selectedEmployee ? (
          <div className="welcome-screen">
            ...
            <div className="welcome-features">
              <div className="feature-card"><div className="fc-icon">▶</div><h3>Session Tracking</h3><p>Start/stop work sessions with categories.</p></div>
              <div className="feature-card"><div className="fc-icon">📊</div><h3>Pattern Analysis</h3><p>Visual charts showing daily activity and trends.</p></div>
              <div className="feature-card"><div className="fc-icon">💡</div><h3>Smart Tips</h3><p>Personalized recommendations based on work patterns.</p></div>
            </div>
          </div>
        ) : (
          <>
...
export default function ProductivityTrackerApp() {
  return (
    <DataProvider>
      <AppContent />
    </DataProvider>
